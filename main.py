...
from controllers.AlgorithmHandler import AlgorithmHandler

def Server(ip, port, debug=True):
    print("py_yolo9_openvino_infer Server http://%s:%d start" % (ip, port))
...
if __name__ == "__main__":
    ...
    Server(ip="0.0.0.0", port=9703, debug=True)
